...
function PaginationItem(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("li", {
    ...
    type: "button",
    className: cx__default["default"](`${prefix}--pagination-nav__page`, {
...
function PaginationOverflow(_ref3) {
  ...
  if (count > 1) {
    return /*#__PURE__*/React__default["default"].createElement("li", {
      ...
      value: "",
      hidden: true
    })), [...Array(count)].map((e, i) => /*#__PURE__*/React__default["default"].createElement("option", {
      value: (fromIndex + i).toString(),
      "data-page": fromIndex + i + 1,
      key: `overflow-${fromIndex + i}`
    }, fromIndex + i + 1))), /*#__PURE__*/React__default["default"].createElement("div", {
      className: `${prefix}--pagination-nav__select-icon-wrapper`
    }, /*#__PURE__*/React__default["default"].createElement(iconsReact.OverflowMenuHorizontal, {
      className: `${prefix}--pagination-nav__select-icon`
    }))));
